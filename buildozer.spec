...
title = Leitor Refeitorio

# (str) Package name
package.name = leitorrefeitorio

# (str) Package domain (needed for android/ios packaging)
package.domain = org.fazendaindependencia
...
requirements = python3, kivy, kivymd, opencv, libzbar, pyzbar, sqlite3
